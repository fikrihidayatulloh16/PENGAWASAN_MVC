    ...
    <div class="card-body">
        <div class="container">
            ...
            <div class="image-container text-center col-lg-6 col-sm-12">
                <img src="<?= PUBLICURL ?>/assets/img/uploads/foto_masalah/<?= $foto_masalah['foto_masalah'] ?>" alt="Foto Kegiatan" class="img-fluid image-rekap mt-3"><br><?= $foto_masalah['permasalahan'] ?>
            </div>
            <?php
                        $num_row++;
                        if ($num_row % 2 == 0) {
            ...
            ?>
            <div class="row">
                <div class="col-12 text-center">Tidak ada data Foto Masalah.</div>
            </div>
            <?php } ?>
        </div>
    </div>
