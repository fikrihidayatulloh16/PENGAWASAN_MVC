                                ...
                                <tbody id="table-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle" style="color: #464F60;">
                                            <a href="<?= PUBLICURL ?>/home/weekly_lh_home/<?= $data['projek']['id_projek']?>/<?= $laporan['tanggal_mulai'] ?>/<?= $laporan['tanggal_selesai'] ?>/<?= $minggu_ke?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="<?= $laporan['tanggal_mulai'] ?> s/d <?= $laporan['tanggal_selesai'] ?>">Minggu ke-<?= $minggu_ke ?></a>
                                        </td>
                            ...
                            <table id="myTable" class="table-thick-border sortable" style="width: 100%;">
                                ...
                                <tbody id="table-body">
                                    ...
                                    <tr>
                                        <td class="text-center align-middle nomor"><?= $nomor ?></td>
                                        <td class="text-center align-middle" style="color: #464F60;">
                                            <a href="<?= PUBLICURL ?>/home/weekly_lh_home/<?= $data['projek']['id_projek']?>/<?= $laporan2['tanggal_mulai'] ?>/<?= $laporan2['tanggal_selesai'] ?>/<?= $minggu_ke?> " data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="<?= $laporan['tanggal_mulai'] ?> s/d <?= $laporan['tanggal_selesai'] ?>">Minggu ke-<?= $minggu_ke ?></a>
                                        </td>
