...
<div class="container mt-5">
        ...
        <div class="d-flex align-items-center">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    ?>
                    <li><a class="dropdown-item" href="<?= PUBLICURL ?>/home/weekly_lh_home/<?= $data['projek']['id_projek']?>/<?= $laporan['tanggal_mulai'] ?>/<?= $laporan['tanggal_selesai'] ?>/<?= $minggu_ke?>">
                    Laporan Mingguan Ke-<?= $minggu_ke ?>
                    </a></li>
                    <?php endforeach ?>
                    <li><a class="dropdown-item" href="<?= PUBLICURL ?>/home">Laporan Harian</a></li>
                </ul>
            </div>
        </div>
        </h5>
    ...
    <div class="container d-flex justify-content-end">
        <a href="<?=PUBLICURL?>/home/laporan_mingguan_user/<?=$data['id_projek']?>" class="btn btn-kembali mt-2">
