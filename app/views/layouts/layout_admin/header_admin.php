...
<head>
  ...
  <link href="<?= PUBLICURL ?>/assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  <link href="<?= PUBLICURL ?>/assets/vendor/quill/quill.snow.css" rel="stylesheet">
  <link href="<?= PUBLICURL ?>/assets/vendor/quill/quill.bubble.css" rel="stylesheet">
  <link href="<?= PUBLICURL ?>/assets/vendor/remixicon/remixicon.css" rel="stylesheet">
  <link href="<?= PUBLICURL ?>/assets/vendor/simple-datatables/style.css" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="<?= PUBLICURL ?>/assets/css/admin_layout.css" rel="stylesheet">
...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="<?= PUBLICURL ?>/home/log_out">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      <li class="nav-item">
        <a class="nav-link " href="<?= PUBLICURL ?>/admin/">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="<?= PUBLICURL ?>/admin/m_pekerjaan/<?= $data['id_projek'] ?>">
              <i class="bi bi-circle"></i><span>Pekerjaan</span>
            </a>
          </li>
          <li>
            <a href="<?= PUBLICURL ?>/admin/m_pekerja/<?= $data['id_projek'] ?>">
              <i class="bi bi-circle"></i><span>Pekerja</span>
            </a>
          </li>
          <li>
            <a href="<?= PUBLICURL ?>/admin/m_peralatan/<?= $data['id_projek'] ?>">
              <i class="bi bi-circle"></i><span>Peralatan</span>
            </a>
          </li>
          <li>
            <a href="<?= PUBLICURL ?>/admin/m_bahan/<?= $data['id_projek'] ?>">
