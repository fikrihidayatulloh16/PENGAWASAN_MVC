...
<head>
    ...
    <link href='https://unpkg.com/boxicons@2.0.7/css/boxicons.min.css' rel='stylesheet'>
     ...
     <link href="<?= PUBLICURL ?>/assets/css/general.css" rel="stylesheet">
</head>
            ...
            <ul class="navbar-nav mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown ms-lg-5">
                    ...
                    <ul class="dropdown-menu"> 
                        ...
                        <li><a class="dropdown-item" href="?= PUBLICURL ?>/operator/index"><i class="bx bx-log-out" style="margin-right: 5px;"></i>Logout</a></li>
                    </ul>
                </li>
                 -->
            </ul>
